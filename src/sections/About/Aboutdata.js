export const credentials = [
  ...
  { icon: "◈", label: "4.9★",   text: "4.9/5 average coaching satisfaction rating" },
];

export const statTrio = [
  { val: "200+", label: "Clients" },
  { val: "6yr",  label: "Coaching" },
  { val: "4.9★", label: "Rating" },
];

export const pressLogos = ["Product School", "Lenny's Newsletter", "PM Dojo"];